// Скрипт для магазина ReallyWorld - BEDROCK
import { supabase } from './supabase.js';

document.addEventListener('DOMContentLoaded', function() {
    console.log('ReallyWorld - BEDROCK загружен');
    ...
    function selectCategory(categoryName, categoryId) {
        window.location.href = `category.html?category=${categoryId}&server=rw-bedrock`;
    }
