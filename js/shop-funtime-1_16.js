// Скрипт для магазина FunTime - 1.16.5 Anarchy
import { supabase } from './supabase.js';

document.addEventListener('DOMContentLoaded', function() {
    console.log('FunTime 1.16.5 Anarchy загружен');
    ...
    function selectCategory(categoryName, categoryId) {
        window.location.href = `category.html?category=${categoryId}&server=funtime-1_16`;
    }
