// Скрипт для магазина HolyWorld - Lite Анархия

document.addEventListener('DOMContentLoaded', function() {
    console.log('HolyWorld Lite Анархия загружен');
    ...
    window.location.href = `category.html?category=${categoryId}&server=holyworld-lite&mode=lite`;
}
