// Скрипт для магазина FunTime - 1.21 Anarchy
import { supabase } from './supabase.js';

document.addEventListener('DOMContentLoaded', function() {
    console.log('FunTime 1.21 Anarchy загружен');
    ...
    function selectCategory(categoryName, categoryId) {
        window.location.href = `category.html?category=${categoryId}&server=funtime-1_21`;
    }
