// Скрипт для магазина ReallyWorld - ГРИФ 1.21
import { supabase } from './supabase.js';

document.addEventListener('DOMContentLoaded', function() {
    console.log('ReallyWorld - ГРИФ 1.21 загружен');
    ...
    function selectCategory(categoryName, categoryId) {
        window.location.href = `category.html?category=${categoryId}&server=rw-grif121`;
    }
