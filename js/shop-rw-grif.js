// Скрипт для магазина ReallyWorld - ГРИФЕРСКОЕ ВЫЖИВАНИЕ
import { supabase } from './supabase.js';

document.addEventListener('DOMContentLoaded', function() {
    console.log('ReallyWorld - ГРИФЕРСКОЕ ВЫЖИВАНИЕ загружен');
    ...
    function selectCategory(categoryName, categoryId) {
        window.location.href = `category.html?category=${categoryId}&server=rw-grif`;
    }
