// Скрипт для магазина ReallyWorld - ГРИФЕРСКОЕ ВЫЖИВАНИЕ (RU)
import { supabase } from './supabase.js';

document.addEventListener('DOMContentLoaded', function() {
    console.log('ReallyWorld - ГРИФЕРСКОЕ ВЫЖИВАНИЕ (RU) загружен');
    ...
    function selectCategory(categoryName, categoryId) {
        window.location.href = `category.html?category=${categoryId}&server=rw-grif-ru`;
    }
